...
function SignInForm ({getDataForm,errorState,loginStatus}) {
    const [formData, setFormData] = React.useState({
        username: "",
        password: "",
    })
    const [error, setError] = React.useState(false)
    const [loginStatusOk, setStatus] = React.useState(false)
    ...
    React.useEffect(()=> {
      errorState ? setError(true) : setError(false)
    }, [errorState])
    React.useEffect(()=>{
      loginStatus ? setStatus(true) : setStatus(false)
    }, [loginStatus])
                  ...
                  <div className="px-4 md:px-0">
                    <div className="md:mx-6 md:p-12">
                      ...
                      <form onSubmit={handleSubmit}>
                        ...
                        {error? <p className="mb-4 text-red-500 animate-pulse">Username or password is incorrect</p> : <p className="mb-4">Please login to your account</p>}
